...
public class LMA extends Comparison{
	...
	public LMA() {
		...
		/**
	 	 ...
	 	 */
		public BufferedImage[][] divide(File imagePath, int widthPixels, int heightPixels) throws IOException,
		ImageDecoderException{
			GrayScale gs = new GrayScale();
			BufferedImage greyImage = gs.makeGrey(imagePath);
